/* $Id: combo_drag.cpp 31859 2009-01-01 10:28:26Z mordante $ */
/*
...
namespace gui {
	...
	combo_drag::combo_drag(display& disp, const std::vector<shared_string>& items, const drop_group_manager_ptr group)
