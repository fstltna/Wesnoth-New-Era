/* $Id: slider.cpp 31858 2009-01-01 10:27:41Z mordante $ */
/*
...
//		line_colour.r, line_colour.g, line_colour.b));
	SDL_SetRenderDrawColor(line_colour.r, line_colour.g, line_colour.b, 0xff);
	SDL_RenderFill(&line_rect);

	SDL_Rect const &slider = slider_area();
	blit_surface(slider.x, slider.y, image);
}
