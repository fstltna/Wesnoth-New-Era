/* $Id: menu.hpp 32028 2009-01-10 11:37:02Z baufo $ */
/*
...
public:
	...
	menu(CVideo& video, const std::vector<shared_string>& items,
	...
	void set_items(const std::vector<shared_string>& items, bool strip_spaces=true,
...
private:
	...
	void fill_items(const std::vector<shared_string>& items, bool strip_spaces);
