/* $Id: combo.hpp 31859 2009-01-01 10:28:26Z mordante $ */
/*
...
{
public:
	combo(display& disp, const std::vector<shared_string>& items);

	void set_selected(int val);
	void set_items(const std::vector<shared_string>& items);
...
private:
	...
	display* disp_;
	static const shared_string empty_combo_label;
