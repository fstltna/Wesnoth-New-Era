/* $Id: statistics_dialog.hpp 31859 2009-01-01 10:28:26Z mordante $ */
/*
...
private:
	void make_damage_line(std::vector<shared_string>&,const std::string&,const long long&,const long long&,const long long&,const long long&);
