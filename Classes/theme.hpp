/* $Id: theme.hpp 31858 2009-01-01 10:27:41Z mordante $ */
/*
...
class theme
{
	...
	struct tborder
	{
		...
		shared_string background_image;
		shared_string tile_image;

		shared_string corner_image_top_left;
		shared_string corner_image_bottom_left;

		shared_string corner_image_top_right_odd;
		shared_string corner_image_top_right_even;

		shared_string corner_image_bottom_right_odd;
		shared_string corner_image_bottom_right_even;

		shared_string border_image_left;
		shared_string border_image_right;

		shared_string border_image_top_odd;
		shared_string border_image_top_even;

		shared_string border_image_bottom_odd;
		shared_string border_image_bottom_even;
...
public:
	...
	private:
		shared_string prefix_, postfix_;
		label label_;
		size_t font_;
		bool font_rgb_set_;
		Uint32 font_rgb_;
	...
	public:
		...
		const std::vector<shared_string>& items() const { return items_; }

		void set_title(const std::string new_title) { title_ = new_title; }
	private:
		bool context_;
		shared_string title_, tooltip_, image_, type_;
		std::vector<shared_string> items_;
	};
    ...
    static std::vector<shared_string> get_known_themes();
