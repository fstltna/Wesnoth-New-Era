/* $Id: multiplayer_connect.hpp 34751 2009-04-12 04:32:38Z alink $ */
/*
...
private:
	...
	std::vector<shared_string> player_types_;
	std::vector<shared_string> player_factions_;
	std::vector<shared_string> player_teams_;
	std::vector<shared_string> player_colours_;
	std::vector<shared_string> ai_algorithms_;

	// team_name list and "Team" prefix
	std::vector<shared_string> team_names_;
	std::vector<shared_string> user_team_names_;
