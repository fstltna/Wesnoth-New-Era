/* $Id: config_cache.hpp 33584 2009-03-13 00:28:27Z soliton $ */
/*
...
// KP: cache functions
extern std::string gTempStr, gTempStr2;		// global temporary strings to reduce unnecessary allocations
extern void cacheFreeStringTable(void);
extern void cacheSaveString(FILE *file, const std::string &str);
extern void cacheSaveStringTable(FILE *file);
extern void cacheLoadStringTable(MEMFILE *file, char *loadBuffer);
extern void cacheLoadString(MEMFILE *file, char **charPtr, unsigned long *strSize);
extern unsigned char *cacheUncompress(std::string &filename);
extern void cacheCompress(std::string &filename);
