/* $Id: hotkeys.hpp 34027 2009-03-22 12:41:54Z ilor $ */
/*
...
public:
	...
	std::vector<shared_string> get_menu_images(const std::vector<shared_string>& items_arg);

	//void show_menu(const std::vector<std::string>& items_arg, int xloc, int yloc, bool context_menu, display& gui);
	void show_menu(const std::vector<shared_string>& items_arg, int xloc, int yloc, bool context_menu, display& gui);
