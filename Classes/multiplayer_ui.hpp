/* $Id: multiplayer_ui.hpp 32674 2009-02-08 13:02:29Z cib $ */
/*
...
protected:
	...
	/** Sets the user list */
	void set_user_list(const std::vector<shared_string>&, bool silent);
	void set_user_menu_items(const std::vector<shared_string>& list);
...
private:
	...
	std::vector<shared_string> user_list_;
