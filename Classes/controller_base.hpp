/* $Id: controller_base.hpp 35582 2009-05-11 23:49:01Z crab $ */
/*
...
protected:
	...
	virtual void show_menu(const std::vector<shared_string>& items_arg, int xloc, int yloc, bool context_menu);
