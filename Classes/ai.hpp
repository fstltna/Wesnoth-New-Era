/* $Id: ai.hpp 31859 2009-01-01 10:28:26Z mordante $ */
/*
...
ai_interface::info info_;
	...
	std::map<shared_string,int> unit_movement_scores_;
	std::set<shared_string> not_recommended_units_;
	...
	std::map<shared_string,int> unit_combat_scores_;
