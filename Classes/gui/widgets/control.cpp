/* $Id: control.cpp 33687 2009-03-15 16:50:42Z mordante $ */
/*
...
void tcontrol::impl_draw_background(/*surface& frame_buffer*/)
{
	...
	SDL_Rect rect = get_rect();
	canvas(get_state()).draw(rect.x, rect.y);
	//CVideo::blit_surface(rect.x, rect.y, canvas(get_state()).surf());
}
...
// KP: removed pango, so eventually will have to re-implement these using SDL_TTF		
