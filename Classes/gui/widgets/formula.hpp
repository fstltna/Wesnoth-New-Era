/* $Id: formula.hpp 31858 2009-01-01 10:27:41Z mordante $ */
/*
...
template<>
inline shared_string tformula<shared_string>::execute(const game_logic::map_formula_callable& variables) const
{
	return game_logic::formula(formula_).execute(variables).as_string();
}
/*
