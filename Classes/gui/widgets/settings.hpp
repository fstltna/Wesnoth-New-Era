/* $Id: settings.hpp 33687 2009-03-15 16:50:42Z mordante $ */
/*
...
struct tgui_definition
{
	...
	std::map<shared_string, twindow_definition> windows;

	std::map<shared_string, twindow_builder> window_types;
private:
	template<class T>
	...
	shared_string sound_button_click_;
	shared_string sound_toggle_button_click_;
	shared_string sound_toggle_panel_click_;
	shared_string sound_slider_adjust_;
