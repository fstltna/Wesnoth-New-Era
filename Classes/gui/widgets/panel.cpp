/* $Id: panel.cpp 31922 2009-01-03 15:45:25Z mordante $ */
/*
...
void tpanel::impl_draw_background(/*surface& frame_buffer*/)
{
	...
	SDL_Rect rect = get_rect();
	canvas(0).draw(rect.x, rect.y);
//	CVideo::blit_surface(rect.x, rect.y, canvas(0).surf());
}
...
void tpanel::impl_draw_foreground(/*surface& frame_buffer*/)
{
	...
	SDL_Rect rect = get_rect();
	canvas(1).draw(rect.x, rect.y);
//	CVideo::blit_surface(rect.x, rect.y, canvas(1).surf());
}
