/* $Id: generator.cpp 31937 2009-01-03 21:40:11Z mordante $ */
/*
...
switch(placement) {                                        \
 ...
 #else
 // KP: fix for iphone, "branch out of range" compile error
	
#define GENERATE_PLACEMENT									\
	if (placement == tgenerator_::horizontal_list)			\
	{														\
		result = new tgenerator                             \
		< minimum											\
		, maximum											\
	...
	else if (placement == tgenerator_::vertical_list)		\
	{														\
		result = new tgenerator								\
		< minimum											\
		, maximum											\
	...
	else if (placement == tgenerator_::grid)				\
	{														\
		result = new tgenerator								\
		< minimum											\
		, maximum											\
	...
	else if (placement == tgenerator_::independant)			\
	{														\
		result = new tgenerator								\
		< minimum											\
		, maximum											\
