/* $Id: settings.cpp 33687 2009-03-15 16:50:42Z mordante $ */
/*
...
void load_settings()
{
	...
	std::string filename = get_cache_dir() + "/gui";
...
std::vector<twindow_builder::tresolution>::const_iterator get_window_builder(const std::string& type)
{
	...
	std::map<shared_string, twindow_builder>::const_iterator
