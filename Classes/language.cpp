/* $Id: language.cpp 34877 2009-04-13 16:07:37Z silene $ */
/*
...
const t_string symbol_table::operator[](const std::string& key) const
//const shared_string& symbol_table::operator[](const std::string& key) const
{
	...
	if(i != strings_.end()) {
		...
		//static shared_string empty_string;
...
const t_string symbol_table::operator[](const char* key) const
//const shared_string& symbol_table::operator[](const char* key) const
{
