...
+ (void) setDashboardOrientation:(UIInterfaceOrientation)orientation
{
	...
	if (instance)
	{
		...
		{
			NSLog(@"This version of OpenFeint can only use a landscape orientation! Defaulting to LandscapeRight.");
			instance->mDashboardOrientation = UIInterfaceOrientationLandscapeRight;
			return;
		}
	}
}
