...
- (void)_KeyboardDidShow:(NSNotification*)notification
{
	...
	// topLevelView can sometimes be nil and this causes a hang in the while loop below
	if (topLevelView)
	{
		while (![topLevelView.superview isKindOfClass:[UIWindow class]])
		{
		...
		CGPoint screenSpaceOrigin = [mScrollContainerView convertPoint:CGPointZero toView:topLevelView];
