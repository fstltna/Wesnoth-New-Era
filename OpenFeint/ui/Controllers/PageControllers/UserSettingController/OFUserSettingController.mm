...
- (IBAction)logout
{
	...
	{
		message = @"Are you sure you wish to logout? No high scores or achievements will be recorded while you're logged out.";
	}
	else
	{
		message = @"Logging out will disable all OpenFeint features.  Are you sure?";
	}
