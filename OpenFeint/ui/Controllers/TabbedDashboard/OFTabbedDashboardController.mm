...
- (id)init
{
	...
	if (self != nil)
	{
		...
		{
			[self addViewController:OpenFeintDashBoardTabNowPlaying ofDisabledControllerName:@"EnableOpenFeintInDashboard" named:[OpenFeint applicationShortDisplayName] activeImage:@"OFDashboardTabNowPlayingLandscapeHit.png" inactiveImage:@"OFDashboardTabNowPlayingLandscape.png" disabledImage:nil andBadgeValue:[NSString stringWithFormat:@"%u",[OpenFeint unviewedChallengesCount] + [OFAnnouncementService unreadAnnouncements]]];
			[self addViewController:OpenFeintDashBoardTabMyFeint	named:@"My Feint" activeImage:@"OFDashboardTabMyFeintLandscapeHit.png" inactiveImage:@"OFDashboardTabMyFeintLandscape.png" disabledImage:@"OFDashboardTabMyFeintLandscapeDisabled.png" andBadgeValue:[NSString stringWithFormat:@"%u",[OpenFeint pendingFriendsCount] + [OpenFeint unreadInboxCount]]];
		...
		{
			[self addViewController:OpenFeintDashBoardTabNowPlaying named:[OpenFeint applicationShortDisplayName] activeImage:@"OFDashboardTabNowPlayingPortraitHit.png" inactiveImage:@"OFDashboardTabNowPlayingPortrait.png" disabledImage:nil andBadgeValue:[NSString stringWithFormat:@"%u",[OpenFeint unviewedChallengesCount] + [OFAnnouncementService unreadAnnouncements]]];
			[self addViewController:OpenFeintDashBoardTabMyFeint	named:@"My Feint" activeImage:@"OFDashboardTabMyFeintPortraitHit.png" inactiveImage:@"OFDashboardTabMyFeintPortrait.png" disabledImage:@"OFDashboardTabMyFeintPortraitDisabled.png" andBadgeValue:[NSString stringWithFormat:@"%u",[OpenFeint pendingFriendsCount] + [OpenFeint unreadInboxCount]]];
